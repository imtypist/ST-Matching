...
//地图的经纬度范围,上海地区http://www.openstreetmap.org/export#map=11/31.2255/121.4889
const double MinLon = 120.9499;
const double MaxLon = 122.0279;
const double MinLat = 30.9629;
const double MaxLat = 31.4878;
class Graph{
private:
